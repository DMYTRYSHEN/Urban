...
const Team = () => {        
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl font-pj">Наша команда</h2>
        </div>
        ...
        <div className="grid max-w-6xl grid-cols-1 px-20 mx-auto mt-12 text-center sm:px-0 sm:grid-cols-2 md:mt-20 gap-x-8 md:grid-cols-4 gap-y-12 lg:gap-x-16 xl:gap-x-20">
            <div>
                ...
                <p className="mt-5 text-lg font-bold text-gray-900 sm:text-xl sm:mt-8 font-pj">Дмитришен Юрій</p>
            ...
            <div>
                ...
                <p className="mt-5 text-lg font-bold text-gray-900 sm:text-xl sm:mt-8 font-pj">Поправка Євген</p>
                <p className="mt-2 text-base font-normal text-gray-600 font-pj">Co founder, CIO</p>
            </div>
            ...
            <div>
                ...
                <p className="mt-5 text-lg font-bold text-gray-900 sm:text-xl sm:mt-8 font-pj">Федорчук Дмитро</p>
                <p className="mt-2 text-base font-normal text-gray-600 font-pj">Co founder, STO</p>
            </div>
            ...
            <div>
                ...
                <p className="mt-5 text-lg font-bold text-gray-900 sm:text-xl sm:mt-8 font-pj">Бойко Антон</p>
                <p className="mt-2 text-base font-normal text-gray-600 font-pj">R&D </p>
            </div>
        </div>
