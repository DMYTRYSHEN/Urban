// import { Typography, Card, CardBody, Button, Modal } from '@material-tailwind/react';
  ...
  return (
    <section className="container mx-auto px-8 py-10 lg:py-28">
      <h2
        ...
        // style={{backgroundColor:'linear-gradient(51deg,#F7B500,#6DD400 76%)'}}
      >
