...
const Callba = () => {
  return (
    ...
    //     </div>
    //     <div class="usp">
    //                     <div class="container mx-auto sm:px-4 max-w-full mx-auto sm:px-4" bis_skin_checked="1">
    //                         <div class="usp_wrapper" bis_skin_checked="1" >
    //                             <div class="usp_cards" bis_skin_checked="1">
    //                                 <a href="#" class="usp_card" data-lag="0.05" data-speed="1" >
    //                                     <div class="heading" bis_skin_checked="1">
    //                                         <h6>
    //                                             Анвар, владелец кафе 
    //                                         </h6>
    //                                         <p>
    //                                           как Deals помог сократить <br /> задержки в оплатах и улучшить обслуживание клиентов
    //                                         </p>
    //                                     </div>
    ...
    //               <g>
    //               <path d="M0 28.4541C0 12.9901 12.536 0.454102 28 0.454102C43.464 0.454102 56 12.9901 56 28.4541C56 43.9181 43.464 56.4541 28 56.4541C12.536 56.4541 0 43.9181 0 28.4541Z" fill="black"></path>
    //               <path d="M30 21L36 28M36 28L30 35.5M36 28H20" stroke="white" stroke-width="2"></path>
    //               </g>
    //               <defs>
    //               <clipPath id="clip0_242_3207">
    ...
    //                                 <a href="mailto:didi@deals.systems" class="usp_card" data-lag="0.1" data-speed="1" >
    //                                     <div class="heading" bis_skin_checked="1">
    //                                         <h6>
    //                                             Стартап по доставке еды в Фергане
    //                                         </h6>
    //                                         <p>
    //                                           как с помощью API они автоматизировали <br/>платежи и выросли в крупнейшую сеть.
    //                                         </p>
    //                                     </div>
    //                                     <div class="cta" bis_skin_checked="1">
    //                                         <p>
    ...
    //                                     <div class="background" bis_skin_checked="1"></div>
    //                                 </a>
    //                                 <a class="usp_card" data-lag="0.15" href="/faq" data-speed="1" >
    //                                     <div class="heading" bis_skin_checked="1">
    //                                         <h6>
    //                                             Крупный ритейлер в Самарканде
    //                                         </h6>
    //                                         <p>
    //                                             как сплитование и эквайринг <br/> позволили бизнесу расширить сеть.
    //                                         </p>
    //                                     </div>
    //                                     <div class="cta" bis_skin_checked="1">
    //                                         <p>
    ...
    <section class="py-24 relative">
      <div class="w-full max-w-7xl mx-auto px-4 md:px-8">
        <div class="grid grid-cols-10 gap-8">
          ...
          <div class="col-span-10 lg:col-span-4 relative h-[273px] rounded-xl flex flex-col justify-end p-6 lg:items-start items-center">

            <video class="absolute inset-0 w-full h-full object-cover z-0 rounded-xl" src={Vid2} autoplay loop muted playsinline></video>


            <div class="relative z-10 text-center lg:text-left">
              <h4 class="font-medium text-xl leading-8 text-white mb-4">Хочеш обговорити проэкт?</h4>
              <form class="form flex flex-col md:flex-row gap-4">
                <div class="flex items-center rounded-[100px] border border-gray-300 bg-transparent py-[10px] px-4 gap-2">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="fill-gray-300" d="..." fill="#111827" />
                  </svg>
                  <input
                    type="text"
                    name="text"
                    placeholder="Enter phone number"
                    class="w-3/5 outline-none border-none font-normal text-base py-[1px] text-gray-400 bg-transparent"
                  />
                </div>
                <button class="bg-indigo-600 rounded-[100px] py-[13px] px-6 font-semibold text-sm text-white whitespace-nowrap focus-within:outline-0 shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-400">
                  Замовити дзвінок
                </button>
              </form>
            </div>
          ...
          <div class="col-span-10 lg:col-span-6 w-full">
            <div class="box flex h-full justify-center flex-col">
              <h2 class="font-manrope font-bold text-3xl leading-10 text-black mb-14 lg:text-left text-center">Також ми забезпечуємо дотаткові опції та функціонал який може стати в нагоді при реалізації Вашого проєкту</h2>
              <div class="grid grid-cols-3 sm:grid-cols-5 w-full">
                <div class="box flex flex-col items-center">
                  ...
                  <p class="mt-2 w-[92px] text-center font-medium text-sm text-black"> Платежі IBAN, та картки</p>
                </div>
                <div class="box flex flex-col items-center">
                  <button class="rounded-full p-3 flex items-center justify-center mx-auto bg-white shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-50 hover:shadow-indigo-200">
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="37" viewBox="0 0 36 37" fill="none">
                  ...
                  <p class="mt-2 w-[92px] text-center font-medium text-sm text-black"> Безкоштовна доставка по Україні </p>
                </div>
                <div class="box flex flex-col items-center">
                  <button class="rounded-full p-3 flex items-center justify-center mx-auto bg-white shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-50 hover:shadow-indigo-200">
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="37" viewBox="0 0 36 37" fill="none">
                  ...
                  <p class="mt-2 w-[92px] text-center font-medium text-sm text-black"> Служба підтримкм </p>
                </div>
                <div class="box flex flex-col items-center">
                  <button class="rounded-full p-3 flex items-center justify-center mx-auto bg-white shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-50 hover:shadow-indigo-200">
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="37" viewBox="0 0 36 37" fill="none">
                  ...
                  <p class="mt-2 w-[92px] text-center font-medium text-sm text-black"> Безкоштовні консультації </p>
                </div>
                <div class="box flex flex-col items-center">
                  <button class="rounded-full p-3 flex items-center justify-center mx-auto bg-white shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-50 hover:shadow-indigo-200">
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="37" viewBox="0 0 36 37" fill="none">
                  ...
                  <p class="mt-2 w-[92px] text-center font-medium text-sm text-black"> Хмарний сервіс для аналізу IOT </p>
                </div>
              </div>
            </div>
          </div>
