      ...
      >
        <div className="relative mb-12">
          ...
          <div className="relative z-10 mx-7 -mt-20 rounded-lg bg-white dark:bg-dark-2 py-[34px] px-3 text-center shadow-portfolio dark:shadow-box-dark">
            ...
            <a
              href={buttonHref}
              className="text-body-color dark:text-dark-6 hover:border-primary hover:bg-primary inline-block rounded-xl border border-stroke dark:border-dark-3 py-[10px] px-7 text-sm font-medium transition hover:text-white bg-gray-100"
            >
              {button}
            </a>
          </div>
